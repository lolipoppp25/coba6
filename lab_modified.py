...
<div class="periodic-header"><p style="font-size:22px;"><span class="animated-emoji">🔥</span><span class="animated-emoji">✨</span><span class="animated-emoji">🧪</span><span class="animated-emoji">💥</span><span class="animated-emoji">🌟</span><span class="animated-emoji">⚗️</span><span class="animated-emoji">🧬</span><span class="animated-emoji">📚</span></p>
        <h2 style="color:white; text-align:center; font-size:32px;">Tabel Periodik Unsur Kimia (118 Unsur)</h2>
        <p style="text-align:center; font-size:18px; color:#FFFFFF; text-shadow:1px 1px 2px rgba(0,0,0,0.7);">Klik pada kartu unsur untuk melihat detail lengkap</p>
    </div>
    """, unsafe_allow_html=True)
...
<div class="periodic-header"><p style="font-size:22px;"><span class="animated-emoji">🔥</span><span class="animated-emoji">✨</span><span class="animated-emoji">🧪</span><span class="animated-emoji">💥</span><span class="animated-emoji">🌟</span><span class="animated-emoji">⚗️</span><span class="animated-emoji">🧬</span><span class="animated-emoji">📚</span></p>
        ...
        <p style="text-align:center; font-size:18px; color:#FFFFFF; text-shadow:1px 1px 2px rgba(0,0,0,0.7);">Pilih dua senyawa untuk melihat reaksi yang terjadi</p>
    </div>
    """, unsafe_allow_html=True)
...
<div class="periodic-header"><p style="font-size:22px;"><span class="animated-emoji">🔥</span><span class="animated-emoji">✨</span><span class="animated-emoji">🧪</span><span class="animated-emoji">💥</span><span class="animated-emoji">🌟</span><span class="animated-emoji">⚗️</span><span class="animated-emoji">🧬</span><span class="animated-emoji">📚</span></p>
        ...
        <p style="text-align:center; font-size:18px; color:#FFFFFF; text-shadow:1px 1px 2px rgba(0,0,0,0.7);">Pelajari konsep-konsep dasar kimia dan eksperimen menarik</p>
    </div>
    """, unsafe_allow_html=True)
...
<div class="periodic-header"><p style="font-size:22px;"><span class="animated-emoji">🔥</span><span class="animated-emoji">✨</span><span class="animated-emoji">🧪</span><span class="animated-emoji">💥</span><span class="animated-emoji">🌟</span><span class="animated-emoji">⚗️</span><span class="animated-emoji">🧬</span><span class="animated-emoji">📚</span></p>
        ...
        <p style="text-align:center; font-size:18px; color:#FFFFFF; text-shadow:1px 1px 2px rgba(0,0,0,0.7);">Pelajari cara menyimpan bahan kimia dengan aman dan kelompok kompatibilitas</p>
    </div>
    """, unsafe_allow_html=True)
